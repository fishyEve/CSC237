...
/*!
 *    \class Node
 *    \brief Header file containing the definition for a Node object 
 *    \file Node.h
 *    \brief Header file containing the definition for a Node object
 *
...
/*!
 *    \class CLinkedList
 *    \brief definition of a circular linked list.
 *    \file CLinkedList.h
 *    \brief definition of a circular linked list
 *
...
/*!
 *    \class CListItr
 *    \brief Definition of an iterator for the CLinkedList.
 *    \file CListItr.h
 *    \brief Definition of an iterator for the CLinkedList
 *
